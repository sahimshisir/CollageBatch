            ...
            <div class="dropdown-shortcuts-list scrollable-container">
              <div class="row row-bordered overflow-visible g-0">
                <div class="dropdown-shortcuts-item col">
                  ...
                  <RouterLink to="/yourBatch">Your Batch</RouterLink>
              ...
              <ul class="list-group list-group-flush">
                <li
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <!-- <img src="./public/frontend/assets/img/avatars/1.png" alt class="h-auto rounded-circle" /> -->
                      </div>
                    </div>
                ...
                <li
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <!-- <img src="./public/frontend/assets/img/avatars/2.png" alt class="h-auto rounded-circle" /> -->
                      </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <li
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <!-- <img src="./public/frontend/assets/img/avatars/9.png" alt class="h-auto rounded-circle" /> -->
                      </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <li
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <!-- <img src="./public/frontend/assets/img/avatars/6.png" alt class="h-auto rounded-circle" /> -->
                      </div>
                    </div>
                    <div class="flex-grow-1">
