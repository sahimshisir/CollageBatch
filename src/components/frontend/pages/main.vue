<template>
          ...
          <div class="modal-body">
            ...
            <div class="comment-body">
              <div class="card-header">
                ...
                <p class="mt-2 p-0">
                  lorem ipsum for caption Lorem ipsum dolor sit amet,
                  consectetur adipisicing elit. Sapiente fugit incidunt
                  inventore dolores pariatur aut iusto aspernatur assumenda
                  architecto consequatur ratione earum id, sint labore officiis
                  quo aperiam vero eligendi!
                </p>
              </div>
              ...
              <div class="d-flex">
                ...
                <div>
                  <p class="card p-3">
                    ...
                    Commodi repellat ad sapiente modi ullam architecto,
                    praesentium odit reiciendis labore ratione!
                  </p>
                </div>
              </div>
    ...
    <div class="modal fade" id="NewPost" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header border-bottom">
            <!-- comment title -->
            <h5 class="modal-title mb-2 mx-auto fs-4 fw-bold" id="modalScrollableTitle">Create Post</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="card-header border-bottom">
              ...
              <!-- post area -->
              <textarea class="form-control border-none post-area shadow-none" placeholder="What's new?" name=""
                id=""></textarea>
              <!-- dropdown modal -->
  ...
  <div class="post-button-container">
    <button class="post-button btn-primary" data-bs-toggle="modal" data-bs-target="#NewPost"><i
        class="fa-solid fa-feather-pointed"></i></button>
  </div>
