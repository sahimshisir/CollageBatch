                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="text-center">
                            ...
                            <a href="#">
                                <p
                                    class="text-center  mt-3 text-capitalize fw-bold mt-1 mb-2 border p-2 border-2 text-heading">
                        ...
                        <li class="d-flex align-items-center mb-3 mt-4">
                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2">Profile :</span>
                            <span class="fw-medium fw-bold text-heading ">Web Developer</span>
                        </li>
                        <li class="d-flex align-items-center mb-3 mt-4">
                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 ">Studied at <span
                                    class="fw-bold text-heading">Idris Ali Madbor Polytecnic Institute</span></span>

                        </li>
                        <li class="d-flex align-items-center mb-3 mt-4">
                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2">Went To</span>
                            <span class="text-capitalize fw-bold text-heading">bajrajogini JK High School</span>
                        </li>
                        <li class="d-flex align-items-center mb-3 mt-4">
                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2">Lives In</span>
                            <span class="text-capitalize fw-bold text-heading">munshiganj, Dhaka Bangladesh</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-flag text-heading"></i><span class="fw-medium mx-2">Country:</span>
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-phone-call"></i><span class="fw-medium mx-2">Contact:</span>
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center flex-wrap mb-3 gap-2">
                            ...
                            <a href="#"><span class="fw-medium mx-2 text-heading"><i
                                        class="ti ti-brand-facebook"></i></span></a>
                            <a href="#"><span class="fw-medium mx-2 text-heading"><i
                                        class="ti ti-brand-instagram"></i></span></a>
                            <a href="#"><span class="fw-medium mx-2 text-heading"><i
                                        class="ti ti-brand-twitter"></i></span></a>
                            <a href="#"><span class="fw-medium mx-2 text-heading"><i
                                        class="ti ti-brand-linkedin"></i></span></a>
                            <a href="#"><span class="fw-medium mx-2 text-heading"><i
                                        class="ti ti-brand-skype"></i></span></a>
                    ...
                    <ul class="list-unstyled mb-0 mt-3">
                        ...
                        <a href="#" type="button" data-bs-toggle="modal" class="d-block"
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-check"></i><span class="fw-medium mx-2">Task Complete:</span>
                        ...
                        <a href="#">
                            <p
                                class="text-center mt-3 text-capitalize fw-bold mt-1 mb-3 border p-2 border-2 text-heading">
                                <i class="ti ti-user text-capitalize"></i>
                                Edit overview
                            </p>
                        </a>
                ...
                <div class="card-header">
                    <div class="d-flex">
                        <div class="avatar me-3">
                            <img src="../../../../assets/frontend/assets/img/avatars/1.png"
                    ...
                    <p class="mt-2 p-0">
                        ...
                        adipisicing elit. Sapiente fugit incidunt inventore dolores pariatur
                        aut iusto aspernatur assumenda architecto consequatur ratione earum
                        id, sint labore officiis quo aperiam vero eligendi!
                    </p>
                </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="comment-body ">
                        <div class="card-header">
                            ...
                            <p class="mt-2 p-0">
                                lorem ipsum for caption Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Sapiente fugit incidunt inventore dolores
                                pariatur aut iusto aspernatur assumenda architecto consequatur
                                ratione earum id, sint labore officiis quo aperiam vero eligendi!
                            </p>
                        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                <p class="card p-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi
                                    repellat ad sapiente modi ullam architecto, praesentium odit reiciendis labore
                                    ratione!</p>
                            </div>
                        </div>
                ...
                <div class="modal-cmt-footer border-top d-flex align-items-center justify-content-around">
                    ...
                    <button type="submit" class="btn"><i class="fa-solid fa-paper-plane me-1"></i>Send</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-heading" id="modalScrollableTitle">Edit Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="profile" class="form-control"
                                placeholder="What's your profile role ?" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="studied" class="form-label">Studied At</label>
                            <input type="text" id="studied" class="form-control" placeholder="Studied at?" />
                        </div>
                    </div>

                    <div class="row">
                        <div class="col mb-3">
                            <label for="went" class="form-label">Went To</label>
                            <input type="text" id="went" class="form-control" placeholder="Went To ?" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="lives" class="form-label">Lives In</label>
                            <input type="text" id="lives" class="form-control" placeholder="Where do you live ?" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="country" class="form-label">Country</label>
                            <input type="text" id="country" class="form-control" placeholder="What's your country ?" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="email" id="email" class="form-control" placeholder="What's your email ?" />
                        </div>
                    </div>
                    <small class="card-text text-uppercase fw-bold badge bg-primary d-block">Social Information</small>
                        ...
                        <div class="row pb-4">
                            <div class="col-12">
                                <button type="button" class="btn btn-primary btn-sm" data-repeater-create><i
                                    class="fa-regular fa-circle-plus me-2 fw-bold rounded-3"></i> Add a social link</button>
                            </div>
                        </div>
                    </form>
...
<script>
import('../../../../assets/frontend/assets/vendor/css/pages/page-profile.css')
// import('../../../../assets/frontend/assets/js/pages-profile')
</script>