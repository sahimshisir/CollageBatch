        ...
        <div class="authentication-inner row">
            ...
            <div class="d-none d-lg-flex col-lg-7 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="../../assets/frontend/assets/img/illustrations/auth-forgot-password-illustration-light.png"
                        alt="auth-forgot-password-cover" class="img-fluid my-5 auth-illustration"
                        data-app-light-img="illustrations/auth-forgot-password-illustration-light.png"
                        data-app-dark-img="illustrations/auth-forgot-password-illustration-dark.png" />
                    <img src="../../assets/frontend/assets/img/illustrations/bg-shape-image-light.png"
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <form id="formAuthentication" class="mb-3" @submit.prevent="sendOtp">
                        <div class="mb-3">
        ...
        async sendOtp() {
            ...
            try {
                ...
                const response = await axios.post(
                    `${this.globalVariables.apiUrl}/forgot-password`, // Ensure the endpoint matches
                    { email: this.email }
                );
